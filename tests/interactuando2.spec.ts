    ...
    test.describe('Acciones en el Automation Sandbox', () => {
        ...
        test('Puedo seleccionar y deseleccionar un checkbox en el @Sandbox', async ({ page }) => {
            ...
            await test.step('Puedo seleccionar el checkbox para Pasta', async () => {
                const sandbox = new SandboxPage(page); //aca estoy instanciando el objeto sanbox de la clase importan Sandbox
                //await page.getByLabel('Pasta 🍝').check();
                await sandbox.checkPasta(); // el objeto sandobox , puede usar el metodo check pasta
            ...
            await test.step('Puedo deseleccionar el checkbox Pasta', async () => {
                const sandbox = new SandboxPage(page); //aca estoy instanciando el objeto sanbox de la clase importan Sandbox
                await sandbox.uncheckPasta(); // el objeto sandobox , puede usar el metodo uncheck pasta
